...
type
  ...
  ISetup4DJSONObject = interface
    ...
    {$IFDEF HAS_PORTUGUES}
    /// <summary>
    /// Retorna a própria instância do objeto JSON.
    /// Marca a instância como proprietária (Owner), indicando que ela é
    /// responsável por liberar a memória associada ao objeto JSON.
    /// </summary>
    /// <returns>
    /// Retorna a própria instância do objeto JSON.
    /// </returns>
    ...
    /// <summary>
    /// Retorna a própria instância do objeto JSON.
    /// Marca a instância como não proprietária (Not Owner), indicando que ela
    /// não é responsável por liberar a memória associada ao objeto JSON.
    /// </summary>
    /// <returns>
    /// Retorna a própria instância do objeto JSON.
    /// </returns>
